...
describe "multiply" do
  ...
  it "multiplies several numbers" do
    expect(multiply(10,5000)).to eq(50_000)
  end
...
describe "factorial" do
  it "computes the factorial of 0 eq 1" do
    expect(factorial(0)).to eq(1)
  end
  it "computes the factorial of 1 eq 1" do
    expect(factorial(1)).to eq(1)
  end
  it "computes the factorial of 2 eq 2" do
    expect(factorial(2)).to eq(2)
  end
  it "computes the factorial of 5 eq 120" do
